...
export default function GlobalSettingsClient({
  ...
  // 2. Batas Waktu Konfirmasi Kedai (Upload Bukti Bayar -> Auto Refund)
  ...
  // 3. Batas Waktu Penerimaan Pesanan Baru oleh Kedai
  ...
  return (
    <div className="grid gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            menyelesaikan pembayaran sebelum pesanan dibatalkan otomatis oleh sistem.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {/* CARD 2: BATAS WAKTU KONFIRMASI KEDAI (AUTO REFUND) */}
      <Card>
        <CardHeader>
      ...
      {/* CARD 3: BATAS WAKTU PENERIMAAN PESANAN BARU */}
      <Card>
        <CardHeader>
